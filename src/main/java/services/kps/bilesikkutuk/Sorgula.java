 ...
 *       &lt;sequence>
 *         &lt;element name="kriterListesi" type="{http://kps.nvi.gov.tr/2017/08/01}ArrayOfBilesikKutukSorgulaKimlikNoSorguKriteri" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Sorgula {
    ...
    @XmlElementRef(name = "kriterListesi", namespace = "http://kps.nvi.gov.tr/2017/08/01", type = JAXBElement.class, required = false)
